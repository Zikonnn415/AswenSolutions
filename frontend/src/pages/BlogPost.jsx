  ...
  return (
    <div className="page-shell" style={{ padding: '3rem 0 6rem' }}>
      <div className="page-wrap" style={{ maxWidth: '52rem' }}>
        ...
        {article.cover_url && (
          <img src={article.cover_url} alt={article.title} style={{ width: '100%', height: '22rem', objectFit: 'cover', borderRadius: '1rem', marginBottom: '2rem', border: '1px solid rgba(16,185,129,0.15)' }} />
        )}
